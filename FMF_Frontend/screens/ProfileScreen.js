...
export default class Profile extends Component {
  ...
  async componentDidMount() {
    ...
    // 1. ------------------------------------------------------------------------------------------
    requestGoogle = async () => {
      const response = await fetch("https://2b6d184479c7.ngrok.io/api/profile/googleid");
    ...
    const requestProfile = async () => {
      ...
      const response = await fetch("https://2b6d184479c7.ngrok.io/api/profile/" + this.state.userId);
      const json = await response.json();
      this.setState({
        dataSource: json,
      });
  ...
  handleSubmit = () => {
    ...
    fetch("https://2b6d184479c7.ngrok.io/api/profile", {
        method: "POST",
        headers: {
  ...
  PutFirstname = (inputText) => {
    ...
    {
      fetch("https://2b6d184479c7.ngrok.io/api/profile/" + this.state.userId , {
        method: "PUT",
        headers: {
          Accept: "application/json",
          "Content-Type": "application/json",
